...
{
    public partial class changedFriendshipActiveness : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthday = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "Birthday of a user who has to be over 16 years old"),
                    Bio = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true, comment: "Short information for the user"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "The unique identifyer of a friendship")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, comment: "The status of a friendship request, can be  pending or active"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Place = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: false, comment: "The location with words of the meeting"),
